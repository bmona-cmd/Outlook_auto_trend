...
#   - Friday 18:30 → Saturday 03:00  (handover)
#   - Saturday 03:00 → Saturday 24:00 (handover)
#   - Sunday 03:00  → Sunday 24:00   (handover)
#   - Saturday/Sunday 06:30 → 18:30 (dispatch)
# ──────────────────────────────────────────
TEST_MODE  = False  
...
#      stopping when we hit a pre-window mail
#      or the inbox bottom
#   3. Sleep 5 minutes
#   4. Repeat until the configured weekend window ends
#   5. After window closes — send Excel report by email
# ──────────────────────────────────────────
